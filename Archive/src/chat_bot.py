...
# def main():
#     api_key = "oL4DCKPyIBwELom4JUfBhsaAyl9sx7Gb"
    
#     while True:
#         user_input = input("Введите ваше сообщение (или 'выход' для завершения): ")
#         if user_input.lower() == "выход":
#             print("Программа завершена.")
#             break
        
#         response = send_message_to_mistral(user_input, api_key)
#         print("Ответ от Mistral:", response)
...
class ChatBot:
    ...
    def __init__(
        ...
        self.mistral_api_key = "oL4DCKPyIBwELom4JUfBhsaAyl9sx7Gb"
    ...
    def send_message_to_mistral(self, message, model="mistral-small-2409"):
        ...
        try:
            ...
            if response:
                print(f"Полный ответ API: {response.text}")
    ...
    def ask(self, query: str, k: int = 5) -> Dict:
        ...
        answer = self.send_message_to_mistral(full_prompt)
